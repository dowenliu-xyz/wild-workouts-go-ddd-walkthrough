...
import (
	...
	trainerHTTP "github.com/dowenliu-xyz/wild-workouts-go-ddd-walkthrough/internal/common/client/trainer"
	...
	"github.com/dowenliu-xyz/wild-workouts-go-ddd-walkthrough/internal/common/tests"
...
func TestMain(m *testing.M) {
	if !startService() {
		log.Println("Timed out waiting for trainer HTTP/gRPC to come up")
		os.Exit(1)
	}
